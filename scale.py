...
#plt.plot(df['Weight'], linestyle='solid', color='red')
#plt.text(20, 1000, 'Weight: ', color='red')
#plt.plot(df['Volume'], linestyle='solid', color='blue')
#plt.text(20, 250, 'Volume: ', color='blue')
#plt.show()
# Scaled Weight and Volume
plt.plot(scaledWeight, linestyle='solid', color='red')
plt.text(25, -1.75, 'Scaled Weight: ', color='red')
plt.plot(scaledVolume, linestyle='solid', color='blue')
plt.text(25, -2, 'Scaled Volume: ', color='blue')
plt.show()
